/*
This Token Contract implements the Elige.re token (beta)
.*/
...
contract Eligere is BurnableToken,Ownable { // Our token is a standard ERC20 Token with burnable and ownable aptitude
	...
	string public name = "Eligere"; //token name 
    	string public symbol = "ELG"; // token symbol
    	uint256 public decimals = 18; // token number of decimal
    	
    	/* Public variables specific for Eligere */
        uint256 public constant MAX_SUPPLY_NBTOKEN   = 20000000000*10**18; // The max cap is 20 Billion Eligere
	...
	function Eligere() {
		...
		dateDefrost = dateStartContract + 60 days; // everybody can defrost his own token after the 20 january 2018
