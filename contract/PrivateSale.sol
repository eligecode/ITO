/*
Contract for the privateSale of the Eligere campaign
...
contract PrivateSale is Ownable{
	...
	Eligere public pecul; // token Eligere
	bool public initPecul; // We need first to init the Eligere Token address
	...
	uint256 rate; // 1 ether = 3 000 ELG, maybe to change
	...
	function InitEligereAdress(address peculAdress) onlyOwner
	{ // We init the Eligere token address
	
		pecul = Eligere(peculAdress);
